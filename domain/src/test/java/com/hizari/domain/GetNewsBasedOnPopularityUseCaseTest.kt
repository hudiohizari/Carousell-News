...
class GetNewsBasedOnPopularityUseCaseTest {
    ...
    fun setUp() {
        ...
        getNewsBasedOnPopularityUseCase = GetNewsBasedOnPopularityUseCase(mockContext, newsRepository)
    }
    ...
    fun `should emit Loading and Success states when repository returns data sorted by timeCreated`() =
        runTest {
            ...
            getNewsBasedOnPopularityUseCase().test {
